...
exports.fetchPatient_Appointments_Using_ID = async function(patient_id) {
    return pool.query(`select patient_first_name, patient_Email, patient_last_name, doctor_first_name, doctor_last_name, gender, doctor_specialization, date_format(doctor_schedule_date,'%b %e, %Y') AS date, time_format(doctor_schedule_start_time, '%h:%i %p') AS doctor_schedule_start_time, doctor_HMO, appointment_status, patient_age from patient
