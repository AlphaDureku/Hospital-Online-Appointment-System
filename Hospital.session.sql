...
values((select patient_id from patient where patient_email = "templanzamark2002@gmail.com"),
 12, (select doctor_id from doctor_schedule_table where doctor_schedule_id =12), curdate(), "Appoinment made by Mark")

insert into appointment_details(appointment_patient_ID, doctor_schedule_id, appointment_doctor_ID, appointment_creation_Date, patient_message)
values((select patient_id from patient where patient_email = "templanzamark2003@gmail.com"), 19,
(select doctor_id from doctor_schedule_table where doctor_schedule_id =19), curdate(), "Appoinment made by John Deep")
